export const Project = [
  ...
  },
  {
    ...
    description:
      "This is a project to explore and <b>analyze models</b> built on breast cancer datasets. The following are the results of the analysis obtained:<br><b>1) Decission Tree Classifier:</b> 73 True Positive, 15 False Negative, 3 False Positive, and 23 True Negative. Accuracy, Precision, Recall, and F1 obtained successively worth 84.21%, 96.05%, 82.95% and 89%. Then, the Accuracy and F1 values for the 10-fold cross validation are 92.32% and 93.51%. When compared with the values obtained from the Decission Tree Classifier, we see a significant difference in values for Accuracy and F1. This means that the model obtained from the Decision Tree Classifier is not the best model and a better model can be searched because of the difference in values.<br><b>2) Id3Estimator:</b> 80 True Positive, 8 False Negative, 1 False Positive, and 25 True Negative. Accuracy, Precision, Recall, and F1 obtained successively worth 92.1%, 98.76%, 90.9% and 94.67%.<br><b>3) K Means:</b> 87 True Positive, 1 False Negative, 9 False Positive, and 17 True Negative. The obtained Accuracy, Precision, Recall, and F1 are 91.22%, 91.49%, 91.22%, and 90.62% respectively.<br><b>4) Logistic Regression:</b> 81 True Positive, 7 False Negative, 1 False Positive, and 25 True Negative. Accuracy, Precision, Recall, and F1 obtained are 92.98%, 98.78%, 92.04% and 95.29% respectively.<br><b>5) Neural Network:</b> 87 True Positive, 1 False Negative, 9 False Positive, and 17 True Negative. The obtained Accuracy, Precision, Recall, and F1 are 91.22%, 91.49%, 91.22%, and 90.62% respectively.<br><b>6) SVM:</b> 85 True Positive, 3 False Negative, 0 False Positive, and 26 True Negative. The obtained Accuracy, Precision, Recall and F1 values are 97.36%, 100%, 96.59% and 98.26% respectively.",
  ...
  },
  {
    ...
    title: "VMall Website",
    description:
      "VMall website is a virtual mall project that was created by PT Halo Industri Digital using <b>CodeIgniter</b> and <b>MySQL</b>. As a Back End Developer in PT Halo Industri Digital, I continued to build the website by adding and fixing some features. Each user account has only one shop that is part of a shop group. Users can manage their profile, products, and product variants. Users can also manage shelf position and entry position of their shop that will be displayed in the Unity poject as a virtual mall UI. Every transaction that occurs in the shop will be recorded in the activity menu.",
  ...
  },
  {
    ...
    description:
      "Extended Survival Shooter is a desktop game developed using <b>C#</b> (<b>Unity</b>). This game has several features, namely story, quest, save game, gameover, scoreboard, main menu, shopkeeper, weapon (default, shotgun, sword, bow), pet (healer, attacker, aura buff), and cheat (no damage, 1 hit kill, motherlode, x2 speed, full HP pet, kill pet).",
  ...
  },
  {
    ...
    description:
      "Binotify website is created using <b>CodeIgniter</b> with some modified configurations and <b>MySQL</b>. The website contains albums and songs that users can listen to. Users are divided into user and admin. User can view album lists and details, view song details, search for songs, and listen to songs. Admin can do things that users do with additions such as deleting and adding albums, removing and adding songs, and viewing a list of existing users.",
  ...
  {
    _id: { $oid: "631a152fa2b7ef0b2f82a1a3" },
    title: "IMPT Report Website",
    description:
  ...
  },
  {
    ...
    description:
      "Buzzer Checker website is created using <b>VueJS</b> and <b>Flask</b> to check a twitter username is a buzzer account or not. The checking process begins by dividing the account into three-dimensional vector then the vector is compared with the vector of a buzzer account.",
  ...
  },
  {
    ...
    description:
      "NIM Finder website is created using <b>ReactJS</b> and <b>Progressive Web App (PWA)</b> to find Bandung Institute of Technology student identity by student ID number, department/major and year of className, and name.",
  ...
  },
  {
    ...
    title: "DNA Website",
    description:
      "DNA website is created using <b>ReactJS</b>, <b>Go</b>, and <b>MySQL</b>. Users can add new diseases to the database. Users can also predict disease by inputting the patient's DNA and provide results with a certain percent match. Users can also search for disease prediction history.",
  ...
  },
  {
    ...
    description:
      "Aether Wars application is created using <b>JavaFX</b> that consists of 2 players with a maximum of 5 cards in each hand. This game consists of 4 phases, namely Draw, Plan, Attack, and End. In Draw, players can get new cards in hand. In Plan, players can add cards to attack or discard cards. In attacking, players attack other players according to their turn.",
  ...
  },
  {
    ...
    title: "Ibu Canggih Website",
    description:
      "Ibu Canggih website is created using <b>ReactJS</b>, <b>ExpressJS</b>, and <b>MySQL</b>. Users can edit profiles and add reward points on the page provided by filling in the required data. This website can display the total points that have been earned by the user and details of each valid and invalid reward point. The website also has admin features that can manage users, whatsapp groups, events, articles, and banners.",
  ...
  },
  {
    ...
    description:
      "Folder Crawling application is created using <b>C#</b> language (<b>.NET</b>) that can model the features of the file explorer on the operating system. By utilizing the Breadth First Search (BFS) and Depth First Search (DFS) algorithms, users can browse the folders in the directory to find the directory that the user wants. The application can also visualize the results of searching the folder in the form of a tree.",
  ...
  },
  {
    ...
    title: "Vaccination Participant Prediction Website",
    description:
  ...
  {
    _id: { $oid: "6409af9a978163a29376ad04" },
    title: "SPE ITB SC Website",
    description:
      "SPE ITB SC website is created using <b>Wordpress</b> CMS that consists of 6 pages, namely Home, About Us, Event, Achievement, Membership, and Register page that embeds the Google registration form. ",
