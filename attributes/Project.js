export const Project = [
  ...
  },
  {
    ...
    description:
      "<b>1) Binotify Website</b> (<b>CodeIgniter</b> and <b>MySQL</b>).<br> Addition: User can subscribe to singers who have registered for Binotify Premium Website and listen to songs from singers who have been subscribed.<br><b>2) Binotify Premium Website</b> (<b>React.js + Vite</b>).<br> Users are divided into admin and singer. Admin can accept or reject subscription requests obtained from Binotify Website. Singer can add, delete, change and view song details.<br><b>3) Binotify REST Service</b> (<b>Nest.js</b> and <b>MySQL</b>).<br> Services: Perform user authentication, provide an endpoint for singers on Binotify Premium Website so they can add, modify, delete, and view song details, and provide an endpoint for viewing singer lists and lists of singer songs.<br><b>4) Binotify SOAP Service</b> (<b>JAX-WS</b> and <b>MySQL</b>).<br> Services: Maintain the security of Binotify Website, receive subscription requests from Binotify Website, send callbacks for acceptance/rejection of subscription requests to Binotify Website, and provide an endpoint for checking request status.",
